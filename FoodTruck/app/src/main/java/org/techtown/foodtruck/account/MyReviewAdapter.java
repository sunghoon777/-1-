...
public class MyReviewAdapter extends RecyclerView.Adapter<MyReviewAdapter.ViewHolder>{
    ...
    public MyReviewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.recyclerview_my_review_item,parent,false);
        return new MyReviewAdapter.ViewHolder(itemView);
    }
    ...
    public void addItem(int i, Review review){
        items.add(i,review);
    }
